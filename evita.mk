...
# WiFi
PRODUCT_COPY_FILES += \
    device/htc/evita/prebuilt/etc/hostapd/hostapd.accept:system/etc/hostapd/hostapd.accept \
    device/htc/evita/prebuilt/etc/hostapd/hostapd.deny:system/etc/hostapd/hostapd.deny \
